        """
        Json Schema Gen 3m18nia
        =======================
        Schema-aware processor designed to validate raw data into clean outputs.
...
from pathlib import Path
        ...
        APP_NAME    = "Json Schema Gen 3m18nia"
        APP_VERSION = "1.0.0"
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Schema-aware processor designed to validate raw data into clean outputs.")
